<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_add.aspx.cs" Inherits="PITAX.admin.user_add" %>
  ...
  <body>
    <div class="x-body">
        ...
        <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="txt_username" name="username" required="" lay-verify="required" runat="server"
                  autocomplete="off" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
